  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe:
        <ol id="wd-burrito-bowls">
          <li>Boil the appropriate amount of water.</li>
          <li>Add 1/4 tbsp of butter to the water as it boils.</li>
          <li>Cook your ground beef.</li>
          <li>When the water is boiling, add your rice and (rinsed) beans.</li>
          <li>Add taco seasoning to both the beef and the rice/beans.</li>
          <li>
            Add cooked beef to the rice and beans when they absorb all of the
            water.
          </li>
          <li>Add cheese, salt, and pepper, and mix thoroughly.</li>
        </ol>
